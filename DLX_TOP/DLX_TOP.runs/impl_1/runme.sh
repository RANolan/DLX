...
HD_PWD='C:/Users/Reith/EE/DLX_TOP/DLX_TOP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DLX_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DLX_TOP.tcl -notrace
