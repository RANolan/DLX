...
HD_PWD='C:/Users/Reith/EE/DLX_TOP/DLX_TOP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DLX_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DLX_TOP.tcl
